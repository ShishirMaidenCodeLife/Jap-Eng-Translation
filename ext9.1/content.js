...
function createPopup() {
    ...
    minimizeButton.innerHTML = '➖'; // Minimizing icon (minus)
    ...
    captionsContainer.style.height = '220px'; // Adjusting height for captions
...
function addResizeHandles(popup) {
    ...
    // Attaching the resize event to the handle
...
function makeDraggable(popup) {
    ...
    popup.onmousedown = function (event) {
        // Ignoring dragging if resizing is in progress ( i I need to look for bugs later in here )
...
async function translateToEnglish(text) {
    // const response = await fetch('https://50067ab8-e253-4748-bbc5-d6844a2ddb2b-00-3ntusni1amp8r.pike.replit.dev/translate', 
    const response = await fetch('localhost:8000/translate',{
        method: 'POST',
        headers: {
